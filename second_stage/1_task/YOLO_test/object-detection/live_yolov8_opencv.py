...
model = YOLO("second_stage/1_task/YOLO_test/object-detection/data/yolov8n.pt")

cap = cv2.VideoCapture("second_stage/1_task/videos/0cdaf025-6350-4b8d-9da8-677c3a16c439.mp4")
_, image = cap.read()
h, w = image.shape[:2]

while True:
    _, image = cap.read()
    #image = image[200:800, 400:1000]
